if _G.__EZLIBS_BOOTED then
  print("[BOOT] ezlibs-scripts/main.lua already booted; skipping duplicate load")
  return
end
_G.__EZLIBS_BOOTED = true
...
pcall(function()
  require('scripts/ezlibs-custom/ezmemory_harden')
end)
...
print("[BOOT] ezlibs-scripts/main.lua running")
